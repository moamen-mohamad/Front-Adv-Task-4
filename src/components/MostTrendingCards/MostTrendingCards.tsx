...
const mostTrendingCards: Array<MostTrendingCards> = [
    {
        id: 1,
        imagePath: "/Front-Adv-Task-4/assets/images/house-1.jpg",
        price: "$300000",
    ...
    {
        id: 2,
        imagePath: "/Front-Adv-Task-4/assets/images/house-2.jpg",
        price: "$450000",
    ...
    {
        id: 3,
        imagePath: "/Front-Adv-Task-4/assets/images/house-3.jpg",
        price: "$850000",
    ...
    {
        id: 4,
        imagePath: "/Front-Adv-Task-4/assets/images/house-4.jpg",
        price: "$210000",
    ...
    {
        id: 5,
        imagePath: "/Front-Adv-Task-4/assets/images/house-5.jpg",
        price: "$1200000",
    ...
    {
        id: 6,
        imagePath: "/Front-Adv-Task-4/assets/images/house-6.jpg",
        price: "$350000",
        ...
        <div className={styles.mostTrendingCardsContainer}>
            {mostTrendingCards.map((card) => (
                <div key={card.id} className={styles.card}>
                    ...
                    <h3>{card.title}</h3>
                    <div>
                        <img src="/Front-Adv-Task-4/assets/images/location-2.svg" alt="location-icon" />
                        <p>{card.address}</p>
                    </div>
                </div>
            ))}
